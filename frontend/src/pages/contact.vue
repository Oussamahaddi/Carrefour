    ...
    <div class="h-screen bg-gradient-to-b from-primary-700/30 overflow-y-auto scrollbar-thumb-primary-700 scrollbar-track-secondary-500 scrollbar-thin">
        ...
        <div class=" my-24 mx-auto">
            ...
            <div class=" text-gray-800 px-4 md:px-12">
                <div class="bg-white/30 w-11/12 mx-auto block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6">
                                ...
                                <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                    <div class="flex items-start">
                                        ...
                                        <div class="grow ml-6">
                                            ...
                                            <p class="text-gray-500">oussama@gmail.com</p>
                                            <p class="text-gray-500">+212 234-567-89</p>
                                        </div>
                                    </div>
                                </div>
