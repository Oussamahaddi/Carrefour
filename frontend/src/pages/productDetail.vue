        ...
        <div class="w-5/6 mx-auto my-24 shadow-[0_0px_4px] shadow-black/30 bg-primary-400/10 rounded-xl py-8 grid grid-cols-1 sm:grid-cols-2 justify-items-center gap-6 h-fit">
            <div class="w-5/6 h-full grid grid-cols-1 grid-rows-[1fr_auto] gap-4">
                <div class="col flex justify-center shadow-[0_0_4px] shadow-black/20 rounded-xl items-center border border-gray-300 product bg-white overflow-hidden relative after:content-['_'] after:absolute after:bg-secondary-500 after:w-1/3 after:h-1/3 after:left-[-5%] after:top-1/2 after:-translate-y-[-50%] after:rotate-45 after:rounded-lg after:opacity-20 before:absolute before:bg-secondary-500 before:w-2/4 before:h-2/4 before:rounded-lg before:right-[-10%] before:top-1/3 before:translate-y-[-50%] before:rotate-45 before:opacity-20 cursor-pointer">
                    <img src="@/assets/image/product/p1.png" alt="big img" class="w-5/6 relative z-10">
                </div>
                <div class="flex justify-between gap-8">
                    <div class="p-2 bg-white shadow-[0_0_4px] shadow-black/10 border border-gray-300 cursor-pointer rounded-xl"><img src="@/assets/image/product/p1.png" alt="img1" class="w-full"></div>
                    <div class="p-2 bg-white shadow-[0_0_4px] shadow-black/10 border border-gray-300 cursor-pointer rounded-xl"><img src="@/assets/image/product/p1.png" alt="img2" class="w-full"></div>
                    <div class="p-2 bg-white shadow-[0_0_4px] shadow-black/10 border border-gray-300 cursor-pointer rounded-xl"><img src="@/assets/image/product/p1.png" alt="img3" class="w-full"></div>
                </div>
            </div>
            <div class="w-5/6 h-full flex flex-col gap-8 justify-center">
                <div>
                    <h1 class="text-xl font-bold">Jus with Ananas</h1>
                </div>
                <div class="text-red-500 text-lg font-semibold"><span>199.99DH</span><span class="">300.99DH</span></div>
                <div>
                    <p class="text-gray-500 text-sm">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus non sit qui quasi laborum natus, cum, asperiores iusto aliquam enim aperiam aut illo ut, saepe fugit voluptate quisquam nostrum adipisci!
                    </p>
                </div>
                <div>
                    <div class="flex items-center">
                        <button @click="minus" class="bg-white shadow-[0_2px_4px] shadow-black/30 rounded-xl px-3 flex items-center justify-center text-xl py-1 font-bold">-</button>
                        ...
                        <button @click="plus" class="bg-black shadow-[0_2px_4px] shadow-black/30 text-white px-3 flex items-center justify-center text-xl py-1 font-bold rounded-xl">+</button>
                    </div>
                </div>
                ...
                <div class="text-sm grid gap-2">
                    <div> <strong>Categorie :</strong> category name</div>
